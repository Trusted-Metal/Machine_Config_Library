# Rust — PASS/FAIL Summary

**Date:** 2026-08-18
**Version:** machine-config 0.2.0-rc.4
**Result:** 20 / 20 PASS
...
AV-09–11 run via `cargo test --test adapter_migration_test` in `rust/` (not the standalone
app — see `results.md` for why). All other scenarios run via `docs/validation/rust/app/`.
