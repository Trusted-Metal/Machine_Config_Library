// Attribute-reading helpers for the mock v1.1 reader.
//
...
// adapter, mock or real, may import another version's adapter code. See the
// package doc in mockv1_1.go for the full rationale.
package mockv1_1
