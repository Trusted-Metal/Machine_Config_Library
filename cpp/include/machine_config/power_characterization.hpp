...
// from power_characterization; Hdf5WriterV1_1 writes power_characterization
...
// came from an actual parse() call — see V1_1_IMPLEMENTATION_PLAN.md Phase
// 2's "Design decision" section for the full comparison.)
//
